  ...
  return (
    <div className="page">
      <main className={styles.resources}>
        <h2 className="page-title">{t("Pages.quebecResources", "Québec resources", pageLocale)}<Image src="/icon/resources.svg" alt={t("Pages.downloads", "Downloads", pageLocale)} width={30} height={30} /></h2>
        ...
        <LastUpdated page="qc/resources" pageLocale={pageLocale} />
      </main>
    </div>
  );
}
